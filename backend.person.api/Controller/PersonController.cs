...
public class PersonController : ControllerBase
{
    ...
    /// <param name="pageSize">The number of objects to return</param>[SwaggerResponse(StatusCodes.Status200OK, "Success to prosses the request.", typeof(PagedList<Person>))]
